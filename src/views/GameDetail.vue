                                  ...
                                  <div class="col">
                                    <div class="row">
                                      ...
                                      <div class="col-12">
                                        <div
                                          class="row"
                                          v-if="detailGame.gameRating"
                                        >
                                          <b-icon
                                            v-for="index in detailGame.gameRating"
                                            :key="index"
                                            class="h5 mb-2"
                                            icon="star-fill"
                                            style="color: orange"
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-12">
                                        <div class="row">
                                          ...
                                          ></b-icon>
                                          {{
                                            detailGame.gamePriceAfterDiscount
                                              | rupiah
                                          }}
                                        </div>
                                      </div>
                      ...
                      >
                        ...
                        <div class="col-6">
                          ...
                          >
                            ...
                            <option
                              :value="index + 1"
                              v-for="(time, index) in chooseTime"
                              :key="index"
                              >{{ time }}</option
                            >
                          </select>
                          <!-- <b-form-timepicker id="time" :hour12="false" :state="isValidTime" v-model="time" class="mb-2"></b-form-timepicker> -->
                        </div>
                      </div>
...
export default {
  ...
  data() {
    return {
      ...
      format: "hh:mm",
      // minTime: moment('07:00:00', this.format),
      // maxTime: moment('21:00:00', this.format),
    ...
    getDetailGame() {
		const currentTime = new Date()
      	this.axios.get("game/web/detail/" + this.gameId).then((response) => {
			...
			if (this.detailGame.timeStart <= currentTime.getHours()) {
				this.playable = true
			}
      	});
    },
  ...
  computed: {
    ...
    isValidTime() {
      return moment(this.time).isBetween(this.time, this.time); // true
      // return moment(this.time).isBetween(this.minTime, this.maxTime);
    },
  },
  mounted() {
